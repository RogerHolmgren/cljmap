...
* [`src/cljmap/`](src/cljmap/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljmap/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `cljmap` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cljmap/config.cljs) defaults to `true` in
...
```clj
(ns cljmap.example
  (:require [cljmap.config :as config])
